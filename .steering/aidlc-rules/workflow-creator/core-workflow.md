...
ルールを読み込む：`details/workflow-creator/inception/context-detection.md`
...
ルールを読み込む：`details/workflow-creator/inception/requirements-analysis.md`
...
ルールを読み込む：`details/workflow-creator/inception/task-analysis.md`

### ステージ1.4 — ファイル構成計画（常に実行）

生成すべきルールファイルの一覧・各ファイルの役割・ディレクトリ構造を設計する。

ルールを読み込む：`details/workflow-creator/inception/workflow-planning.md`
...
ルールを読み込む：`details/workflow-creator/construction/core-workflow-template.md`
...
ルールを読み込む：`details/workflow-creator/construction/inception-rules-template.md`
...
ルールを読み込む：`details/workflow-creator/construction/construction-rules-template.md`
...
ルールを読み込む：`details/workflow-creator/construction/operations-rules-template.md`

### ステージ2.5 — セッション状態ファイル生成（常に実行）

`aidlc-state.md` テンプレートを生成する。

ルールを読み込む：`details/workflow-creator/construction/state-template.md`

### ステージ2.6 — 全体レビュー（常に実行）

生成したファイル群を横断的にレビューし、一貫性・網羅性・実用性を確認する。

ルールを読み込む：`details/workflow-creator/construction/review.md`
...
ルールを読み込む：`details/workflow-creator/operations/integration-advice.md`
...
実際のルールファイルのうちcore-workflow.mdは`aidlc-rules/[作業名]/` に配置する。
core-workflow.mdから参照される他のファイル群は`details/[作業名]/` に配置する。
